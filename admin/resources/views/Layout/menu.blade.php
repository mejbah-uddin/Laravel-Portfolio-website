        ...
        <div class="scroll-sidebar">
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                  ...
                  <li> <a href="{{url('/projects')}}" ><span> <i class="fas fa-book-reader"></i> </span><span class="hide-menu">Projects</span></a></li>

                  <li> <a href="{{url('/contacts')}}" ><span> <i class="fas fa-envelope"></i> </span><span class="hide-menu">Message</span></a></li>

                  <li> <a href="{{url('/reviews')}}" ><span> <i class="fas fa-comments"></i> </span><span class="hide-menu">Reviews</span></a></li>

                  <li> <a href="{{url('/photos')}}" ><span> <i class="fas fa-images"></i> </span><span class="hide-menu">Photo Gallery</span></a></li>
