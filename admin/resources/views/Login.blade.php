    ...
    <div style="height: 450px" class="col-md-6 p-3">
      <form  action=" "  class="m-5 loginForm">
        ...
        <label for="exampleInputEmail1">User Name</label>
         <input required="" name="username" value="" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter User Name Or Email">
        </div>
        <div class="form-group">
...
<img class="w-75 m-5" src="http://localhost/images/bannerImg.png">
</div>
</div>
</div>
...
<script type="text/javascript">
  $('.loginForm').on('submit', function(event){
    ...
    let userNameOrEmail = formData[0]['value'];
    let passsword = formData[1]['value'];
    let url = '/onLogin';
    ...
    .catch(error => {
        toastr.error('Login faild ! Try Again  Try Again');
    })
